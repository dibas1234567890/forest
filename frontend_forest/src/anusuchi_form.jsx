...
const AnusuchiForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const dataToSubmit = {
            ...formData,
            DFO_officer_signature: JSON.stringify(signatureData) 
        };

        try {
            const postResponse = await axios.post('http://127.0.0.1:8000/api/anusuchi_form', dataToSubmit, {
                headers: {
                    'X-CSRFToken': csrfToken,
                    'Authorization': `Bearer ${token}`,
                },
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <select
                                                    ...
                                                    required
                                                    id="id_division_forest_office"
                                                    value={formData.division_forest_office}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input
                                                    type="text"
                                                    name="division_forest_office_location"
                                                    required
                                                    id="id_division_forest_office_location"
                                                    value={formData.division_forest_office_location}
                                                    onChange={handleChange}
                                                />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input
                                                    type="text"
                                                    name="sub_division_department"
                                                    required
                                                    id="id_sub_division_department"
                                                    value={formData.sub_division_department}
                                                    onChange={handleChange}
                                                />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input
                                                    type="text"
                                                    name="ghatgaddhi_place_name"
                                                    required
                                                    id="id_ghatgaddhi_place_name"
                                                    value={formData.ghatgaddhi_place_name}
                                                    onChange={handleChange}
                                                />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input
                                                    ...
                                                    id="id_notice_published_date"
                                                    value={formData.notice_published_date}
                                                    onChange={handleChange}
                                                />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input
                                                    type="date"
                                                    name="last_date_to_receive"
                                                    id="id_last_date_to_receive"
                                                    value={formData.last_date_to_receive}
                                                    onChange={handleChange}
                                                />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input
                                                    type="text"
                                                    name="forest_department"
                                                    required
                                                    id="id_forest_department"
                                                    value={formData.forest_department}
                                                    onChange={handleChange}
                                                />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input
                                                    type="number"
                                                    name="days_to_pick_up"
                                                    required
                                                    id="id_days_to_pick_up"
                                                    value={formData.days_to_pick_up}
                                                    onChange={handleChange}
                                                />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input
                                                    type="date"
                                                    name="last_date_to_pick_up"
                                                    id="id_last_date_to_pick_up"
                                                    value={formData.last_date_to_pick_up}
                                                    onChange={handleChange}
                                                />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input
                                                    type="text"
                                                    name="cc_division_forest_office"
                                                    required
                                                    id="id_cc_division_forest_office"
                                                    value={formData.cc_division_forest_office}
                                                    onChange={handleChange}
                                                />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input
                                                    type="text"
                                                    name="cc_sub_division_forest_office"
                                                    required
                                                    id="id_cc_sub_division_forest_office"
                                                    value={formData.cc_sub_division_forest_office}
                                                    onChange={handleChange}
                                                />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input
                                                    type="text"
                                                    name="cc_finance_dept_division_forest_office"
                                                    required
                                                    id="id_cc_finance_dept_division_forest_office"
                                                    value={formData.cc_finance_dept_division_forest_office}
                                                    onChange={handleChange}
                                                />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <SignatureCapture hiddenInputRef={hiddenInputRef} setSignatureData={setSignatureData} />
                                                    <input
                                                        type="hidden"
                                                        ref={hiddenInputRef}
