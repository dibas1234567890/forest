          ...
          <div className="row">
            ...
            <ul className='navbar-nav mr-auto'> 
                ...
                {isLoggedIn ? (
                    ...
                    <>
                        <li className='nav-item' ><Link  className='nav-link' to="/api/register">Register</Link></li>
                        <li className='nav-item'><Link className='nav-link'  to="/api/login">Login</Link></li>
                    </>
                )}
            </ul>
        </nav>
